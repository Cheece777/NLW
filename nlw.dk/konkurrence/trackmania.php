...
<body>
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      <p>Den store Trackmania turnering med høj musik og masser af stemning!</p>
    </div>
    <div class='panel-heading'>§1 Format</div>
    <ul class="list-group">
      <li class="list-group-item">§1.1 Valget af baner bliver foretaget af administrator før turneringsstart.</li>
      <li class="list-group-item">§1.2 Der bliver spillet mellem 6-15 baner af alle typer, nogle lette andre svære.</li>
      <li class="list-group-item">§1.3 Hver bane køres 7 minutter</li>
      <li class="list-group-item">§1.4 Efter hver bane bliver der uddelt point.</li>
      <li class="list-group-item">1. plads = <b>5 point</b></li>
      <li class="list-group-item">2. plads = <b>3 point</b></li>
      <li class="list-group-item">3. plads = <b>1 point</b></li>
      <li class="list-group-item">§1.4 Når alle baner er kørt, er vinderen den med flest point.</li>
    </ul>

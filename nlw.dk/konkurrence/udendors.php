...
<body>
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-heading banner-udendors"></div>
      <div class="panel-body">
      <div class="panel panel-primary">
        <!-- Default panel contents -->
        <div class="panel-heading">Keyboard Kast</div>
        <div class="panel-body">
          <p>Få et afbræk fra spilleriet og kom ud og bevis overfor dine kammerater at du er en vaske ægte keyboard mester kaster!</p>
        </div>
      ...
      <div class="panel panel-primary">
        <!-- Default panel contents -->
        <div class="panel-heading">Cocio Crashing</div>
        <div class="panel-body">
          <p>Udendørs konkurrencerne fortsætter i den klassiske LAN dyst; Cocio Crashing. Her har du igen mulighederne for at bevise at du kan slynge en hel Cocio i svælget hurtigere end dine kammerater!</p>
        </div>

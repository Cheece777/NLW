  ...
  <?php include filter_input(INPUT_SERVER, 'DOCUMENT_ROOT'). '/includes/upper-body.php'; ?>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        ...
        <p>Næste NLW #16 afholdes fra 21. april kl. 18:00 til  23. april kl. 10:00.</p>
      </div>
    </div>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <p>Til Nøvling LAN Week vil der være mulighed for at købe diverse drikke og mad. Udvalget kan variere, men herunder er priserne på de faste vare.</p>
        
        <ul class="list-group">
          <li class="list-group-item">
            <span class="badge">20 kr</span>
            Fri kaffe under hele NLW
          </li>
          <li class="list-group-item">
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <p>Prisen for deltagelse til Nøvling LAN Week variere, da man kan tilkøbe mad. Det er også værd at bemærke, at prisen er billigere, hvis man bestiller sin billet i god tid.</p>
        
        <ul class="list-group">
          <li class="list-group-item">
            <span class="badge">175 kr</span>
            Forudbestilling mere end 1 måned før /med mad
          </li>
          <li class="list-group-item">
            <span class="badge">150 kr</span>
            Forudbestilling mere end 1 måned før /uden mad
          </li>
          <li class="list-group-item">
            <span class="badge">200 kr</span>
            Forudbestilling mindre end 1 måned før /med mad
          </li>
          <li class="list-group-item">
            <span class="badge">175 kr</span>
            Forudbestilling mindre end 1 måned før /uden mad
          </li>
          <li class="list-group-item">
            <span class="badge">200 kr</span>
          ...
          <li class="list-group-item">
            ...
            Gæstebillet /uden computer eller mad
          </li>
        </ul>
    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <p>Alle glemte sager fra et arrangement tages billede af, og ligges op på vores Facebook side.Ser du noget, du har mistet kan vi kontaktes <a href="/kontakt">her</a>.​</p>
